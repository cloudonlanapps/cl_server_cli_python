...
def test_store_get_success(mock_store_manager, sample_entity, mandatory_args):
...
def test_store_get_with_version(mock_store_manager, sample_entity, mandatory_args):
