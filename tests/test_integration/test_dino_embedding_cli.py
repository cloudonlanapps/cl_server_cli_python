...
class TestDinoEmbeddingCLI:
    ...
    def test_dino_embed_http_polling(
        ...
        """Test dino-embedding embed with HTTP polling (default behavior)."""
        ...
        result = cli_runner.invoke(
            ...
            [
                ...
                "dino-embedding", "embed", str(test_image),
            ],
        )
    ...
    def test_dino_embed_mqtt_callbacks(
        ...
        """Test dino-embedding embed with MQTT callbacks (--watch flag)."""
    ...
    def test_dino_embed_with_output(
        ...
        """Test dino-embedding embed with output file download."""
    ...
    def test_dino_embed_invalid_file(
        ...
        """Test dino-embedding embed with missing file."""
