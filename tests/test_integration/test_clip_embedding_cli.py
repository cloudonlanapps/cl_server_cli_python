"""Integration tests for CLIP embedding CLI commands.

Run with:
    pytest tests/test_integration/test_clip_embedding_cli.py \
...
class TestClipEmbeddingCLI:
    """Test CLIP embedding CLI commands against live services."""

    def test_clip_embed_http_polling(
        self,
    ...
    def test_clip_embed_invalid_file(
        self,
        cli_runner: CliRunner,
        cli_env: dict,
    ):
