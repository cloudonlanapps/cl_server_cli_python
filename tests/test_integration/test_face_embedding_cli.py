...
class TestFaceEmbeddingCLI:
    ...
    def test_face_embed_http_polling(
        ...
        """Test face-embedding embed with HTTP polling and JSON output."""
        ...
        assert job.task_type == "face_embedding"
    ...
    def test_face_embed_mqtt_callbacks(
        ...
        """Test face-embedding embed with MQTT callbacks (--watch flag) and JSON output."""
    ...
    def test_face_embed_with_output(
        ...
        """Test face-embedding embed with output file download and JSON output."""
    ...
    def test_face_embed_invalid_file(
        ...
        """Test face-embedding embed with missing file returns JSON error."""
